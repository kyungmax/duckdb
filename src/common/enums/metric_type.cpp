...
profiler_settings_t MetricsUtils::GetOptimizerMetrics() {
    return {
        ...
        MetricsType::OPTIMIZER_MATERIALIZED_VIEW,
    };
}
...
MetricsType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
    switch(type) {
        ...
        case OptimizerType::MATERIALIZED_VIEW:
            return MetricsType::OPTIMIZER_MATERIALIZED_VIEW;
       default:
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricsType type) {
    switch(type) {
        ...
        case MetricsType::OPTIMIZER_MATERIALIZED_VIEW:
            return OptimizerType::MATERIALIZED_VIEW;
    default:
